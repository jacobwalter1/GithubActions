[![Run App Jacob Walter](https://github.com/jacobwalter1/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/jacobwalter1/GithubActions/actions/workflows/run-app.yaml)
